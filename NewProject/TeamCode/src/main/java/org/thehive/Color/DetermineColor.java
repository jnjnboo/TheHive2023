...
import org.thehive.Constants;
import org.thehive.Constants.ColorPreset;
import org.thehive.Utils.FileUtils;
...
public class DetermineColor {
    ...
    public DetermineColor(int cameraMonitorViewId) {
...
//    double ratioLeft = getClosenessToColor(stoneLeft, ACTIVE_BLACK) / getClosenessToColor(stoneLeft, ACTIVE_ORANGE);
        ...
        Log.println(Log.INFO, "bitmapFILTER yellow for right", String.valueOf(getClosenessToColor(stoneRight, ColorPreset.PURE_ORANGE)));
        Log.println(Log.INFO, "bitmapFILTER yellow for center", String.valueOf(getClosenessToColor(stoneCenter, ColorPreset.PURE_ORANGE)));
        Log.println(Log.INFO, "bitmapFILTER yellow for left", String.valueOf(getClosenessToColor(stoneLeft, ColorPreset.PURE_ORANGE)));
        Log.println(Log.INFO, "bitmapFILTER yellow for right", String.valueOf(getClosenessToColor(stoneRight, ColorPreset.PURE_GREEN)));
        Log.println(Log.INFO, "bitmapFILTER yellow for center", String.valueOf(getClosenessToColor(stoneCenter, ColorPreset.PURE_GREEN)));
        Log.println(Log.INFO, "bitmapFILTER yellow for left", String.valueOf(getClosenessToColor(stoneLeft, ColorPreset.PURE_GREEN)));
        Log.println(Log.INFO, "bitmapFILTER yellow for right", String.valueOf(getClosenessToColor(stoneRight, ColorPreset.PURE_PURPLE)));
        Log.println(Log.INFO, "bitmapFILTER yellow for center", String.valueOf(getClosenessToColor(stoneCenter, ColorPreset.PURE_PURPLE)));
        Log.println(Log.INFO, "bitmapFILTER yellow for left", String.valueOf(getClosenessToColor(stoneLeft, ColorPreset.PURE_PURPLE)));
        Log.println(Log.INFO, "bitmapFILTER black for right", String.valueOf(getClosenessToColor(stoneRight, ColorPreset.PURE_GRAY)));
        Log.println(Log.INFO, "bitmapFILTER black for center", String.valueOf(getClosenessToColor(stoneCenter, ColorPreset.PURE_GRAY)));
        Log.println(Log.INFO, "bitmapFILTER black for left", String.valueOf(getClosenessToColor(stoneLeft, ColorPreset.PURE_GRAY)));
/*
...
*/
        double orng=getClosenessToColor(stoneCenter, ColorPreset.PURE_ORANGE);
        double gren=getClosenessToColor(stoneCenter, ColorPreset.PURE_GREEN);
        double purp=getClosenessToColor(stoneCenter, ColorPreset.PURE_PURPLE);
